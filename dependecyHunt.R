library(readxl)
packet <- read_excel("C:/Users/Rogério/Documents/R/Pacotes Hemps MPEG.xlsx")
                 ### Valor MACRO com tamanho do vetor de dependecy, deve ter tamanho
                                        ### igual ao número de pacotes enviados pelo segundo nó.
